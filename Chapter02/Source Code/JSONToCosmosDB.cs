...
namespace CosmosLoadADEA
{
    class Program
    {
        private static readonly string EndpointUri = "https://<accountname>.documents.azure.com:443/";
        private static readonly string PrimaryKey = "<account key>";
        private static CosmosClient cosmosClient;
        private static Database database;
        private static Container container;

        private static string databaseId = "<database>";
        ...
        {
            var sqlQueryText = "SELECT c.partition FROM c";
            ...
            while (queryResultSetIterator.HasMoreResults)
            {
                ...
                {
                    brainwaves.Add(wave);
                    Console.WriteLine($"\tRead {wave.Partition}, {wave.Session.POWReading[0].ReadingDate}\n");
                }
            }
        }
        private static async Task AddItemsToContainer()
        {
            ...
            try
            {
                ...
                sessions.Add(@"C:\Temp\csharpguitar-brainjammer-pow-2134.json");
                sessions.Add(@"C:\Temp\csharpguitar-brainjammer-pow-2142.json");
